...
enum Transmogrifier {
    ...
    private static func updateVersionMin(_ data: Data, _ offset: UInt32, _ minos: UInt32, _ sdk: UInt32) -> Data {
    ...
    static func processBinary(atPath path: String, minos: UInt32, sdk: UInt32) {
        ...
        let editedCommandsData = loadCommandsData
            .map { (lc) -> Data in
                ...
                case LC_VERSION_MIN_IPHONEOS:
                    return updateVersionMin(lc, offset, minos, sdk)
...
let minos = UInt32(CommandLine.arguments[2]) ?? 12
let sdk = UInt32(CommandLine.arguments[3]) ?? 14
